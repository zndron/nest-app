...
export class Migration1740063335873 implements MigrationInterface {
    name = 'Migration1740063335873'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`user\` (\`id\` int NOT NULL AUTO_INCREMENT, \`email\` varchar(32) NOT NULL, \`password\` varchar(60) NOT NULL, \`firstName\` varchar(32) NOT NULL, \`lastName\` varchar(32) NOT NULL, \`active\` tinyint NOT NULL DEFAULT 1, INDEX \`IDX_843f46779f60b45032874be95b\` (\`active\`), UNIQUE INDEX \`IDX_e12875dfb3b1d92d7d7c5377e2\` (\`email\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
